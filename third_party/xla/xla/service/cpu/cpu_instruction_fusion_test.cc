...
ENTRY %main (Arg_0: f32[10,10], Arg_1: f32[10,10]) -> f32[10,10] {
  %Arg_0 = f32[10,10]{1,0} parameter(0), metadata={op_name="x"}
  %Arg_1 = f32[10,10]{1,0} parameter(1), metadata={op_name="y"}
  %Add = f32[10,10]{1,0} add(f32[10,10]{1,0} %Arg_0, f32[10,10]{1,0} %Arg_1)
  %Sub = f32[10,10]{1,0} subtract(f32[10,10]{1,0} %Arg_0, f32[10,10]{1,0} %Arg_1)
  ROOT %subtract_multiply_fusion = f32[10,10]{1,0} fusion(f32[10,10]{1,0} %Add, f32[10,10]{1,0} %Sub), kind=kCustom, calls=%fused_computation
}
)";
